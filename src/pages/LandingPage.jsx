function LandingPage() {
  return (
    <div>
      {/* Hero Section */}
      <section
        className="bg-cover bg-center text-black py-24 px-6"
        style={{
          backgroundImage: "url('https://png.pngtree.com/thumb_back/fh260/background/20241022/pngtree-a-picture-of-human-body-with-blue-lung-cancer-surgery-partial-image_16439944.jpg')", // Replace with your image URL
        }}
      >
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl mb-6 max-w-2xl mx-auto">
            A comprehensive platform dedicated to empowering patients and
            caregivers with advanced adenocarcinoma care.
          </p>
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pr-10 text-center md:text-left">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              cutting-edge solutions for adenocarcinoma patients. Our mission
              is to empower patients, caregivers, and healthcare providers with
